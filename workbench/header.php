...
if (isLoggedIn() && termsOk() && $myPage->title !== 'Login') {
    ...
    print "<td id='myUserInfo' class='slds-p-vertical_medium slds-text-title_caps slds-text-align_right'><a href='sessionInfo.php' onmouseover='showToolTip(\"" . implode("<br/>", $infoTips) . "\", \"large\", \"top-left\", event);'>" .
